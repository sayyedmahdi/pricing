...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'link' => 'لینک',
        'full_name' => 'نام کامل',
        'load_date' => 'تاریخ بارگیری',
        'vehicle_tonnage_id' => 'نوع بارگیر',
        'vehicle_type_id' => 'نوع خودرو',
        'commodity_type_id' => 'انواع کالا',
        'owner_id' => 'صاحب کالا',
        'tonnage' => 'تناژ',
        'cost' => 'ارزش',
        'commodity_properties' => 'ویژگی کالا',
        'vehicle_count' => 'تعداد خودروی مورد نیاز',
        'suggested_shipping_cost' => 'قیمت پیشنهادی ',
        'suggested_admin_shipping_cost' => 'قیمت پیشنهادی ادمین ',
        'discharge_date' => 'تاریخ تخلیه',
        'expire_date' => 'تاریخ انقضا',
        'surname' => 'نام خانوادگی',
        'national_code' => 'کد ملی',
        'postal_code' => 'کد پستی',
        'reg_code' => 'کد ثبت شرکت',
        'agent_name' => 'نماینده شرکت',
        'agent_phone' => 'شماره تماس نماینده شرکت',
        'min_amount' => 'حداقل بار',
        'max_amount' => 'حداکثر بار',
        'standard_vehicle_tonnage' => 'مقدار بار استاندارد',
        'city_id' => 'شهر',
        'lat' => 'عرض جغرافیایی',
        'long' => 'طول جغرافیایی',
        'navy_id' => 'ناوگان',
        'father_name' => 'نام پدر',
        'license_expire_date' => 'تاریخ انقضا گواهینامه',
        'smart_expire_date' => 'تاریخ انقضا شناسه هوشمند',
        'health_expire_date' => 'تاریخ انقضا سلامت',
        'sh_sh' => 'شماره شناسنامه',
        'issue_place' => 'محل صدور',
        'license_number' => 'شماره گواهینامه',
        'license_issue_place' => ' محل صدور گواهینامه',
        'smart_number' => 'شماره هوشمند',
        'health_number' => 'شماره سلامت',
        'plate' => 'پلاک خودرو',
        'insurance_number' => 'شماره بیمه',
        'insurance_expire_date' => 'تاریخ انقضای بیمه',
        'owner_name' => 'نام مالک',
        'owner_national_code' => 'کد ملی مالک',
        'owner_mobile' => 'شماره موبایل مالک',
        'fani_number' => 'کارت معاینه فنی',
        'engine_number' => 'شماره موتور',
        'fani_expire_date' => 'اعتبار معاینه فنی',
        'body_insurance_expire_date' => 'اعتبار بیمه بدنه',
        'insurance_company' => 'شرکت بیمه',
        'body_insurance_number' => 'شماره بیمه بدنه',
        'body_insurance_company' => 'شرکت بیمه بدنه',
        'build_date' => 'سال ساخت',
    ],
];
